...
function PaymentHistory({ customer }) {
    ...
    return ((0, jsx_runtime_1.jsx)(Section, { title: "Payment history", children: history.length > 0 ? ((0, jsx_runtime_1.jsx)("div", { className: "space-y-2", children: history.map((payment) => ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-start justify-between gap-3 rounded-xl border border-white/10 bg-white/[0.025] px-3 py-3", children: [(0, jsx_runtime_1.jsxs)("div", { className: "min-w-0", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-wrap items-center gap-2", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-sm font-semibold text-zinc-100", children: formatCurrency(Number(payment.amount), payment.currency) }), (0, jsx_runtime_1.jsx)(PaymentSourceBadge, { source: payment.source })] }), (0, jsx_runtime_1.jsx)("p", { className: "mt-1 text-xs text-zinc-600", children: new Date(payment.created_at).toLocaleString(undefined, {
                                    day: "numeric",
                                    month: "short",
                                    year: "numeric",
                                    hour: "numeric",
                                    minute: "2-digit",
                                }) })] }), (0, jsx_runtime_1.jsx)(lucide_react_1.ReceiptText, { className: "mt-0.5 h-4 w-4 shrink-0 text-zinc-600" })] }, payment.id))) })) : ((0, jsx_runtime_1.jsx)("div", { className: "rounded-xl border border-dashed border-white/10 bg-white/[0.02] px-4 py-4 text-sm text-zinc-600", children: "Payments you record for this customer will appear here with the exact amount and timestamp." })) }));
}
// ---------------------------------------------------------------------------
// Payment tab
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
function AutomationTab({ customer, isDevelopment, }) {
    return null;
}
// ---------------------------------------------------------------------------
// Main drawer component
// ---------------------------------------------------------------------------
function CustomerDrawer({ customer, initialTab = "payment", isDevelopment, onClose, }) {
    const [tab, setTab] = (0, react_1.useState)(initialTab);
    if (!customer)
        return null;
    const daysOverdue = (0, types_1.getDaysOverdue)(customer);
    const remaining = (0, types_1.getRemainingBalance)(customer);
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { className: "fixed inset-0 z-40 bg-black/60 backdrop-blur-sm", onClick: onClose, "aria-hidden": "true" }), (0, jsx_runtime_1.jsxs)("div", { role: "dialog", "aria-label": `Customer detail: ${customer.recipient_name}`, className: "fixed inset-y-0 right-0 z-50 flex w-full max-w-md flex-col border-l border-border bg-card shadow-2xl shadow-black/50", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-start justify-between border-b border-border p-5", children: [(0, jsx_runtime_1.jsxs)("div", { className: "min-w-0", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-wrap items-center gap-2", children: [(0, jsx_runtime_1.jsx)("h2", { className: "text-lg font-semibold tracking-tight text-zinc-50", children: customer.recipient_name }), remaining <= 0 && ((0, jsx_runtime_1.jsx)(badge_1.Badge, { variant: customer.client_paid_at ? "success" : "default", children: customer.client_paid_at ? "Customer marked paid" : "You marked paid" })), daysOverdue && ((0, jsx_runtime_1.jsxs)(badge_1.Badge, { variant: "danger", children: [daysOverdue, "d overdue"] }))] }), (0, jsx_runtime_1.jsxs)("form", { action: customers_1.updateCustomerEmail, className: "mt-1.5 flex items-center gap-2 max-w-[280px]", children: [(0, jsx_runtime_1.jsx)("input", { type: "hidden", name: "customer_id", value: customer.id }), (0, jsx_runtime_1.jsx)(input_1.Input, { name: "recipient_email", type: "email", defaultValue: customer.recipient_email || "", placeholder: "Add email address...", required: true, className: "h-7 text-xs bg-transparent border-white/10 hover:border-white/20 px-2 flex-1 min-w-0" }), (0, jsx_runtime_1.jsx)(button_1.Button, { type: "submit", variant: "secondary", size: "sm", className: "h-7 px-2.5 text-xs shrink-0", children: "Save" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-3 flex flex-wrap gap-4 text-sm", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("span", { className: "text-zinc-600", children: "Total due " }), (0, jsx_runtime_1.jsx)("span", { className: "font-semibold text-zinc-100", children: formatCurrency(Number(customer.amount_owed), customer.currency) })] }), remaining !== Number(customer.amount_owed) && ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("span", { className: "text-zinc-600", children: "Remaining " }), (0, jsx_runtime_1.jsx)("span", { className: "font-semibold text-zinc-100", children: formatCurrency(remaining, customer.currency) })] })), customer.due_date && ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("span", { className: "text-zinc-600", children: "Due " }), (0, jsx_runtime_1.jsx)("span", { className: (0, utils_1.cn)("font-semibold", daysOverdue ? "text-red-300" : "text-zinc-100"), children: new Date(customer.due_date).toLocaleDateString() })] }))] })] }), (0, jsx_runtime_1.jsxs)("button", { type: "button", onClick: onClose, className: "ml-3 shrink-0 rounded-lg p-1.5 text-zinc-500 transition-colors hover:bg-white/[0.06] hover:text-zinc-200", children: [(0, jsx_runtime_1.jsx)(lucide_react_1.X, { className: "h-4 w-4" }), (0, jsx_runtime_1.jsx)("span", { className: "sr-only", children: "Close" })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex gap-1 border-b border-border px-3 py-2", children: [(0, jsx_runtime_1.jsx)(TabButton, { active: tab === "payment", onClick: () => setTab("payment"), icon: lucide_react_1.CheckCircle2, label: "Payment" }), (0, jsx_runtime_1.jsx)(TabButton, { active: tab === "promise", onClick: () => setTab("promise"), icon: lucide_react_1.Clock, label: "Promise" }), (0, jsx_runtime_1.jsx)(TabButton, { active: tab === "followup", onClick: () => setTab("followup"), icon: lucide_react_1.MessageSquare, label: "Follow-up" }), (0, jsx_runtime_1.jsx)(TabButton, { active: tab === "notes", onClick: () => setTab("notes"), icon: lucide_react_1.FileText, label: "Notes" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex-1 overflow-y-auto", children: [(0, jsx_runtime_1.jsxs)("div", { className: "p-5", children: [tab === "payment" && (0, jsx_runtime_1.jsx)(PaymentTab, { customer: customer }), tab === "promise" && (0, jsx_runtime_1.jsx)(PromiseTab, { customer: customer }), tab === "followup" && (0, jsx_runtime_1.jsx)(FollowUpTab, { customer: customer }), tab === "notes" && (0, jsx_runtime_1.jsx)(NotesTab, { customer: customer })] }), (0, jsx_runtime_1.jsx)("div", { className: "border-t border-white/[0.04] px-5 py-4", children: (0, jsx_runtime_1.jsxs)("form", { action: customers_1.deleteCustomer, children: [(0, jsx_runtime_1.jsx)("input", { type: "hidden", name: "customer_id", value: customer.id }), (0, jsx_runtime_1.jsxs)("button", { type: "submit", className: "flex items-center gap-2 text-xs text-zinc-700 transition-colors hover:text-red-400", onClick: (e) => {
                                                if (!window.confirm(`Delete ${customer.recipient_name}? This cannot be undone.`)) {
                                                    e.preventDefault();
                                                }
                                            }, children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Trash2, { className: "h-3.5 w-3.5" }), "Delete customer"] })] }) })] })] })] }));
}

...
exports.buildMaturityReportPdf = buildMaturityReportPdf;
require("server-only");
function buildMaturityReportPdf(params) {
    const lines = [
        ...
        "",
        "Category Scores",
        ...params.results.categories.map((c) => `${c.label}: ${c.percentage}% (${c.score}/${c.maxScore})`),
        "",

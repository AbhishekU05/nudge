...
exports.syncQuickBooks = void 0;
const client_1 = require("@/lib/inngest/client");
const quickbooks_1 = require("@/lib/quickbooks");
const admin_1 = require("@/lib/supabase/admin");
const logger_1 = require("@/lib/logger");
exports.syncQuickBooks = client_1.inngest.createFunction({ id: "sync-quickbooks", triggers: [{ cron: "0 * * * *" }] }, async ({ step }) => {
    ...
    for (const integration of integrations || []) {
        ...
        try {
            const result = await (0, quickbooks_1.syncQuickBooksInvoicesForOrg)(integration.organization_id);

...
exports.entityDefinitions = [
    ...
    },
    {
        ...
        metaDescription: "Post-invoice collections is the process of tracking unpaid invoices and following up until payment is received. Learn how agencies manage it.",
        h1: "What Is Post-Invoice Collections?",
        definition: "Post-invoice collections is the operational workflow that begins after an invoice is sent and ends when payment is received in full. It includes tracking invoice status, sending payment reminders, logging client payment promises, recording partial payments, escalating overdue accounts, and maintaining a communication history for each client.",
        keyPoints: [
    ...
    },
    {
        ...
        metaDescription: "Accounts receivable for agencies is money clients owe for completed work. Learn how small agencies track AR and reduce payment delays.",
        h1: "What Is Accounts Receivable for Agencies?",
        definition: "Accounts receivable (AR) for agencies is the total amount of money clients owe for work that has been invoiced but not yet paid. For small marketing, design, web, and content agencies, AR management includes sending invoices promptly, tracking overdue balances, following up consistently, documenting payment promises, and reviewing outstanding amounts weekly to protect cash flow.",
        keyPoints: [
...
function getEntityBySlug(slug) {
    return exports.entityDefinitions.find((entity) => entity.slug === slug);
}

...
exports.default = ForConsultantsPage;
...
async function ForConsultantsPage({ searchParams, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "flex flex-1 flex-col overflow-x-hidden", children: [homeSchemas.map((schema, index) => ((0, jsx_runtime_1.jsx)(script_1.default, { id: `schema-${index}`, type: "application/ld+json", dangerouslySetInnerHTML: {
                ...
                } }, index))), (0, jsx_runtime_1.jsx)(auth_error_redirect_1.AuthErrorRedirect, {}), (0, jsx_runtime_1.jsx)(site_header_1.SiteHeader, {}), (0, jsx_runtime_1.jsxs)("main", { id: "main-content", className: "flex-1", children: [(0, jsx_runtime_1.jsx)("section", { className: "py-28 sm:py-36", children: (0, jsx_runtime_1.jsxs)(container_1.Container, { className: "max-w-3xl text-center", children: [(0, jsx_runtime_1.jsx)("h1", { className: "text-4xl font-bold tracking-tight text-zinc-50 sm:text-5xl lg:text-6xl", children: "You provide high-level consulting. Stop doing low-level debt collection." }), (0, jsx_runtime_1.jsx)("p", { className: "mt-6 text-lg leading-relaxed text-zinc-400 max-w-lg mx-auto", children: "Protect your consulting relationships by automating your invoice follow-ups and tracking payment promises effortlessly." }), (0, jsx_runtime_1.jsx)("div", { className: "mt-10 flex items-center justify-center", children: (0, jsx_runtime_1.jsx)("a", { href: "/how-it-works", className: "inline-flex items-center rounded-lg bg-indigo-600 px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-indigo-500/20 transition hover:bg-indigo-500", children: "See how it works" }) })] }) }), (0, jsx_runtime_1.jsx)(landing_page_body_1.LandingPageBody, {})] }), (0, jsx_runtime_1.jsx)(site_footer_1.SiteFooter, {})] }));
}

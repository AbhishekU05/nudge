...
function ToolPage() {
    return ((0, jsx_runtime_1.jsxs)("div", { className: "flex flex-1 flex-col overflow-x-hidden", children: [(0, jsx_runtime_1.jsx)(site_header_1.SiteHeader, {}), (0, jsx_runtime_1.jsx)("main", { id: "main-content", className: "flex-1 pb-24 pt-16 sm:pb-32 sm:pt-24 lg:pb-40 bg-background", children: (0, jsx_runtime_1.jsxs)(container_1.Container, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "mx-auto max-w-2xl text-center mb-12", children: [(0, jsx_runtime_1.jsx)("h1", { className: "text-3xl font-semibold tracking-[-0.04em] text-zinc-50 sm:text-5xl", children: "Collections ROI Calculator for Freelancers and Agencies" }), (0, jsx_runtime_1.jsx)("p", { className: "mt-6 text-lg text-zinc-400", children: "Time spent chasing payments is time you aren't spending billing clients or growing your agency. Calculate the exact ROI of automating your collections." })] }), (0, jsx_runtime_1.jsxs)("div", { className: "mx-auto max-w-3xl", children: [(0, jsx_runtime_1.jsx)(calculator_1.CollectionsROICalculator, {}), (0, jsx_runtime_1.jsx)("div", { className: "mt-12 text-center p-8 rounded-2xl border border-indigo-500/20 bg-indigo-500/5", children: (0, jsx_runtime_1.jsxs)(link_1.default, { href: "/signup", className: "inline-flex items-center text-lg font-medium text-indigo-400 hover:text-indigo-300 transition-colors", children: ["Save your results and track outstanding invoices in Duely ", (0, jsx_runtime_1.jsx)(lucide_react_1.ArrowRight, { className: "ml-2 h-5 w-5" })] }) })] })] }) }), (0, jsx_runtime_1.jsx)(site_footer_1.SiteFooter, {})] }));
}

...
async function AnalyticsPage(props) {
    ...
    const events = (eventsRes.data || []).filter(e => e.customer_id && customerIds.has(e.customer_id));
    return ((0, jsx_runtime_1.jsx)("div", { className: "flex min-h-screen flex-col", children: (0, jsx_runtime_1.jsx)("main", { id: "main-content", className: "flex-1", children: (0, jsx_runtime_1.jsxs)(container_1.Container, { className: "py-8 sm:py-10", children: [(0, jsx_runtime_1.jsxs)("div", { className: "mb-8 flex items-center justify-between", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h1", { className: "text-4xl font-semibold tracking-[-0.04em] text-zinc-50 sm:text-5xl", children: "Analytics" }), (0, jsx_runtime_1.jsx)("p", { className: "mt-3 max-w-2xl text-base leading-7 text-zinc-500", children: "Deep dive into your collection metrics and customer insights." })] }), (0, jsx_runtime_1.jsx)(currency_selector_1.CurrencySelector, { currencies: uniqueCurrencies, selected: selectedCurrency })] }), (0, jsx_runtime_1.jsx)(analytics_client_1.AnalyticsClient, { customers: customers, events: events, currency: selectedCurrency })] }) }) }));
}

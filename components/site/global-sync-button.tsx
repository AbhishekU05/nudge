...
import { syncXeroBackground } from "@/app/actions/integrations";
import { cn } from "@/lib/utils";

export function GlobalSyncButton({ isExpanded }: { isExpanded: boolean }) {
  ...
  const handleSync = () => {
    ...
    startTransition(async () => {
      const res = await syncXeroBackground();
      setMessage({
        text: res.message,
  ...
  return (
    <div className="relative flex w-full">
      ...
      >
        ...
        {isExpanded && <span className="text-sm font-medium">Sync Xero</span>}
      </button>

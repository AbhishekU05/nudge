...
export function InteractiveAppDemo() {
  const [activeTab, setActiveTab] = useState<"dashboard" | "action-center" | "pipeline" | "analytics">("dashboard");
  const [isExpanded, setIsExpanded] = useState(false);

  const navItems = [
    { id: "dashboard", name: "Dashboard", icon: LayoutDashboard, color: "text-indigo-400", hoverColor: "hover:text-indigo-400", activeBg: "bg-indigo-500/10" },

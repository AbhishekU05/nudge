...
function ActionCard({ task }: { task: ActionTask }) {
  let borderClass = "";
  let bgClass = "";
  let textClass = "";
  let icon = null;
  ...
  // Use a sensible currency default or extract if available
  const currency = "USD"; // Could be enhanced to pull from client/invoice if available

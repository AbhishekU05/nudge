...
const initialInputs: PaymentLeakInputs = {
  activeClients: 8,
  averageInvoiceValue: 75000,
  latePaymentPercentage: 45,
  monthlyOperatingExpenses: 350000,
  paymentDelayDays: 21,
};
          ...
          <div className="mx-auto grid w-full max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-semibold tracking-tight text-zinc-50">
                Email the PDF report to yourself.
              </h2>
              <p className="mt-4 max-w-2xl text-sm leading-6 text-zinc-400">
                Results stay visible here. Submit your details only when you
                want the PDF copy with inputs, calculations, score breakdown,
            ...
            <form onSubmit={submitReport} className="space-y-4">
              ...
              {status === "sent" && (
                <p className="text-sm text-emerald-300">
                  Report sent. Check your inbox for the PDF.
                </p>
              )}
              {status === "error" && (
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <h2 className="max-w-2xl text-3xl font-semibold tracking-tight text-zinc-50">
                  Duely keeps client payment follow-ups from slipping.
                </h2>
                <p className="mt-4 max-w-2xl text-base leading-7 text-zinc-400">
                  Duely tracks payment promises, follow-ups, and reminders
  ...
  return (
    <Card className="border-white/10 bg-white/[0.03]">
      ...
      <CardContent>
        ...
        {note && <p className="mt-2 text-sm text-amber-300">{note} risk</p>}
      </CardContent>
    </Card>
  );
}
    ...
    <div className="mx-auto max-w-sm">
      ...
      <div className="mt-4 text-center">
        ...
        <p className="mt-2 text-sm text-zinc-400">
          Higher scores indicate more collection risk.
        </p>
      </div>
    </div>
  );

...
import { PaymentTermsGenerator } from "./calculator";
        ...
        <Container>
          <div className="mx-auto max-w-2xl text-center mb-12">
            <h1 className="text-3xl font-semibold tracking-[-0.04em] text-zinc-50 sm:text-5xl">
              Free Payment Terms Generator for Freelancers
            </h1>
            <p className="mt-6 text-lg text-zinc-400">
              Clear payment terms prevent late payments before they happen. Use this tool to generate air-tight payment terms you can copy and paste into your next contract or invoice.
            </p>
          </div>
          
          <div className="mx-auto max-w-3xl">
            <PaymentTermsGenerator />

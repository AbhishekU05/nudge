...
export const metadata: Metadata = {
  title: "Collections Management for Small Agencies | Duely",
  description: "Bring operational clarity to your post-invoice workflow. Track what's owed and get paid faster without damaging client relationships.",
  alternates: {
            ...
            <div className="grid gap-16 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              <FadeIn className="max-w-2xl">
                <h1 className="mt-8 text-pretty text-5xl font-semibold tracking-[-0.04em] text-zinc-50 sm:text-6xl lg:text-[4.5rem] lg:leading-[1.05]">
                  Stop letting unpaid invoices slow down your agency's growth.
                </h1>
              ...
              <FadeIn delay={0.0}>
                <Card className="h-full border-white/10 bg-white/[0.02]">
                  <CardContent className="p-6">
                    ...
                    <p className="text-zinc-300 font-medium">You have 12 open invoices and 3 spreadsheets to track them.</p>
                  </CardContent>
                </Card>
              </FadeIn>
              <FadeIn delay={0.1}>
                <Card className="h-full border-white/10 bg-white/[0.02]">
                  <CardContent className="p-6">
                    ...
                    <p className="text-zinc-300 font-medium">Someone on your team followed up but you don't know what was said.</p>
                  </CardContent>
                </Card>
              </FadeIn>
              <FadeIn delay={0.2}>
                <Card className="h-full border-white/10 bg-white/[0.02]">
                  <CardContent className="p-6">
                    ...
                    <p className="text-zinc-300 font-medium">A client paid half. You're not sure how much is still owed.</p>
                  </CardContent>
                </Card>
              </FadeIn>
            </div>
            ...
            <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              <FadeIn className="max-w-xl lg:pr-12">
                ...
                <h2 className="text-pretty text-3xl font-semibold tracking-[-0.03em] text-zinc-50 sm:text-4xl">
                  Record payment promises securely.
                </h2>
                <p className="mt-6 text-lg leading-relaxed text-zinc-400">
                  When an agency client promises payment next week, log it. Everyone on your team stays informed without digging through Slack.
                </p>
              </FadeIn>
            </div>
          </Container>
          <Container>
            <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              <FadeIn className="max-w-xl lg:pr-12">
                ...
                <h2 className="text-pretty text-3xl font-semibold tracking-[-0.03em] text-zinc-50 sm:text-4xl">
                  Draft professional follow-ups instantly.
                </h2>
                <p className="mt-6 text-lg leading-relaxed text-zinc-400">
                  Keep agency communications perfectly on-brand by picking the right tone and generating a draft instantly.
                </p>
              </FadeIn>
            </div>
          </Container>
          <Container>
            <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              <FadeIn className="max-w-xl lg:pr-12">
                ...
                <h2 className="text-pretty text-3xl font-semibold tracking-[-0.03em] text-zinc-50 sm:text-4xl">
                  Manage complex partial payments.
                </h2>
                <p className="mt-6 text-lg leading-relaxed text-zinc-400">
                  Agency retainers often involve partial payments. Duely clearly displays what's paid and what's owed.
                </p>
              </FadeIn>
            </div>
          </Container>
          <Container>
            <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              <FadeIn className="max-w-xl lg:pr-12">
                ...
                <p className="mt-6 text-lg leading-relaxed text-zinc-400">
                  Let Duely handle the repetitive follow-ups so your agency account managers can focus on client work.
                </p>
              </FadeIn>
            </div>
          </Container>
          <Container>
            <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              <FadeIn className="max-w-xl lg:pr-12">
                ...
                <h2 className="text-pretty text-3xl font-semibold tracking-[-0.03em] text-zinc-50 sm:text-4xl">
                  Reminders from your agency's domain.
                </h2>
                <p className="mt-6 text-lg leading-relaxed text-zinc-400">
                  Duely connects to your Google Workspace, so reminders come from 'accounting@youragency.com' instead of a generic third-party address.
                </p>
              </FadeIn>
            </div>
          </Container>
          <Container>
            <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              <FadeIn className="max-w-xl lg:pr-12">
                ...
                <h2 className="text-pretty text-3xl font-semibold tracking-[-0.03em] text-zinc-50 sm:text-4xl">
                  A centralized timeline for your team.
                </h2>
                <p className="mt-6 text-lg leading-relaxed text-zinc-400">
                  See exactly who followed up, when, and what the client said in one unified timeline.
                </p>
              </FadeIn>
            </div>
          </Container>
            ...
            <div className="mx-auto max-w-3xl">
              ...
              <div className="space-y-8">
                  ...
                  <FadeIn key={0} delay={0 * 0.05}>
                    <div>
                      <h3 className="text-lg font-medium text-zinc-100">Can multiple team members use Duely?</h3>
                      <p className="mt-2 text-zinc-400 leading-relaxed">Yes. Duely centralizes the timeline so your whole team knows the status of an invoice.</p>
                    </div>
                  </FadeIn>
                  <FadeIn key={1} delay={1 * 0.05}>
                    <div>
                      <h3 className="text-lg font-medium text-zinc-100">Does this replace our accounting software?</h3>
                      <p className="mt-2 text-zinc-400 leading-relaxed">No, it integrates with it. Connect your QuickBooks or Xero and Duely handles the collections workflow.</p>
                    </div>
                  </FadeIn>
                  <FadeIn key={2} delay={2 * 0.05}>
                    <div>
                      <h3 className="text-lg font-medium text-zinc-100">Can we send reminders from a shared inbox?</h3>
                      <p className="mt-2 text-zinc-400 leading-relaxed">You can connect the Google Workspace account associated with your billing email to send reminders.</p>
                    </div>
                  </FadeIn>
                  <FadeIn key={3} delay={3 * 0.05}>
                    <div>
                      <h3 className="text-lg font-medium text-zinc-100">How do you handle partial retainer payments?</h3>
                      <p className="mt-2 text-zinc-400 leading-relaxed">Simply log the partial payment in Duely, and the remaining balance is automatically updated and tracked.</p>
                    </div>
                  </FadeIn>
                  <FadeIn key={4} delay={4 * 0.05}>
                    <div>
                      <h3 className="text-lg font-medium text-zinc-100">Are the automated reminders customizable?</h3>
                      <p className="mt-2 text-zinc-400 leading-relaxed">Yes. You can edit every draft and choose the tone of the message to match your agency's voice.</p>
                    </div>
                  </FadeIn>
              </div>
            </div>

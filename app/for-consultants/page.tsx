                  ...
                  <Card className="overflow-hidden border-white/10 bg-white/[0.02] p-6 shadow-xl shadow-black/20">
                    <CardContent className="p-0">
                      <div className="flex items-center gap-4 border-b border-white/10 pb-6">
                        ...
                        <div>
                          <p className="font-semibold text-zinc-100">abhishek@consultant.com</p>
          ...
          <Container>
            <div className="mx-auto max-w-2xl text-center mb-16">
              ...
              <p className="mt-4 text-lg text-zinc-400">
                The complete toolkit for managing consultant cashflow, without the awkward conversations.
              </p>
            </div>

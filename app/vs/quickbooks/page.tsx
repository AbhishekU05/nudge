...
export const metadata: Metadata = {
  title: "Duely vs QuickBooks: Which Is Right for You? (2026)",
  description: "QuickBooks handles invoicing. Duely handles what comes after. Here's exactly how they differ and which fits your workflow.",
  alternates: {
    canonical: "/vs/quickbooks",
  },
};
        ...
        <Container>
            ...
            <table className="w-full text-left text-sm text-zinc-300">
              <thead className="bg-zinc-900/80 text-zinc-100">
                <tr>
                  ...
                  <th className="px-6 py-4 font-medium border-b border-white/5">QuickBooks</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                ...
                <tr className="bg-zinc-900/30">
                  ...
                  <td className="px-6 py-4 font-medium text-zinc-300">Starts at $30/mo</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="mx-auto mt-16 max-w-4xl grid gap-8 md:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-8">
              ...
              <p className="mt-4 leading-relaxed text-zinc-400">
                Business owners who use standard accounting software but need a specialized, human-centric layer to manage the awkward conversations and follow-ups required to actually get paid.
              </p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-8">
              <h2 className="text-xl font-semibold text-zinc-50">Who QuickBooks is for</h2>
              <p className="mt-4 leading-relaxed text-zinc-400">
                Established agencies and businesses that require deep financial reporting, strict double-entry accounting, payroll integration, and a system their CPA already knows.
              </p>
            </div>
          </div>
          ...
          <div className="mx-auto mt-16 max-w-4xl rounded-2xl border border-indigo-500/20 bg-indigo-500/5 p-8 sm:p-12 text-center">
            ...
            <p className="mt-4 text-lg leading-relaxed text-zinc-400 mx-auto max-w-2xl">
              Duely isn&apos;t built to replace QuickBooks. It&apos;s built to work alongside it. Let QuickBooks handle the heavy lifting of accounting and invoice generation. When an invoice becomes overdue, plug Duely into your workflow to manage the delicate process of actually getting paid without straining your client relationships.
            </p>
            <div className="mt-8">
              <Link href="/signup">

              ...
              <FadeIn delay={0.0}>
                <Card className="h-full border-white/10 bg-white/[0.02]">
                  <CardContent className="p-6">
                    ...
                    <p className="text-zinc-300 font-medium">You finished the work. Now comes the awkward part.</p>
                  </CardContent>
                </Card>
              </FadeIn>
              <FadeIn delay={0.1}>
                <Card className="h-full border-white/10 bg-white/[0.02]">
                  <CardContent className="p-6">
                    ...
                    <p className="text-zinc-300 font-medium">You promised yourself you'd follow up on Monday.</p>
                  </CardContent>
                </Card>
              </FadeIn>
              <FadeIn delay={0.2}>
                <Card className="h-full border-white/10 bg-white/[0.02]">
                  <CardContent className="p-6">
                    ...
                    <p className="text-zinc-300 font-medium">Your client said Friday. It's Wednesday.</p>
                  </CardContent>
                </Card>
              </FadeIn>
            </div>
            ...
            <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              <FadeIn className="max-w-xl lg:pr-12">
                ...
                <h2 className="text-pretty text-3xl font-semibold tracking-[-0.03em] text-zinc-50 sm:text-4xl">
                  Track promises directly from clients.
                </h2>
                <p className="mt-6 text-lg leading-relaxed text-zinc-400">
                  When a freelance client says they'll pay by Friday, Duely logs it. No more trying to remember what was agreed on.
                </p>
              </FadeIn>
            </div>
          </Container>
          <Container>
            <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              <FadeIn className="max-w-xl lg:pr-12">
                ...
                <h2 className="text-pretty text-3xl font-semibold tracking-[-0.03em] text-zinc-50 sm:text-4xl">
                  Draft the perfect follow-up email.
                </h2>
                <p className="mt-6 text-lg leading-relaxed text-zinc-400">
                  Choose a tone (friendly, firm, or final) and Duely drafts the email. Edit it slightly to match your freelance brand before hitting send.
                </p>
              </FadeIn>
            </div>
          </Container>
          <Container>
            <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              <FadeIn className="max-w-xl lg:pr-12">
                ...
                <p className="mt-6 text-lg leading-relaxed text-zinc-400">
                  Freelance clients sometimes pay half now, half later. Duely helps you track exactly how much is still owed.
                </p>
              </FadeIn>
            </div>
          </Container>
          <Container>
            <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              <FadeIn className="max-w-xl lg:pr-12">
                ...
                <p className="mt-6 text-lg leading-relaxed text-zinc-400">
                  Set automated sequences. If they don't reply, Duely follows up again so you don't have to.
                </p>
              </FadeIn>
            </div>
          </Container>
          <Container>
            <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              <FadeIn className="max-w-xl lg:pr-12">
                ...
                <p className="mt-6 text-lg leading-relaxed text-zinc-400">
                  A reminder from an automated billing system looks like a collection agency. A reminder from your actual Gmail looks like you.
                </p>
              </FadeIn>
            </div>
          </Container>
          <Container>
            <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              <FadeIn className="max-w-xl lg:pr-12">
                ...
                <p className="mt-6 text-lg leading-relaxed text-zinc-400">
                  Every message, promise, and partial payment is stored in chronological order so you know exactly what happened before reaching out.
                </p>
              </FadeIn>
            </div>
          </Container>
            ...
            <div className="mx-auto max-w-3xl">
              ...
              <div className="space-y-8">
                  ...
                  <FadeIn key={0} delay={0 * 0.05}>
                    <div>
                      <h3 className="text-lg font-medium text-zinc-100">Is this better than my invoicing tool's built-in reminders?</h3>
                      <p className="mt-2 text-zinc-400 leading-relaxed">Yes. Most invoicing tools send generic reminders. Duely lets you track promises, partial payments, and sends personalized reminders directly from your Gmail.</p>
                    </div>
                  </FadeIn>
                  <FadeIn key={1} delay={1 * 0.05}>
                    <div>
                      <h3 className="text-lg font-medium text-zinc-100">Will my clients know I'm using an automated tool?</h3>
                      <p className="mt-2 text-zinc-400 leading-relaxed">No. Emails come directly from your Gmail address and look like you wrote them manually.</p>
                    </div>
                  </FadeIn>
                  <FadeIn key={2} delay={2 * 0.05}>
                    <div>
                      <h3 className="text-lg font-medium text-zinc-100">What if a freelance client pays partially?</h3>
                      <p className="mt-2 text-zinc-400 leading-relaxed">Duely makes it simple to log partial payments and automatically tracks the remaining balance.</p>
                    </div>
                  </FadeIn>
                  <FadeIn key={3} delay={3 * 0.05}>
                    <div>
                      <h3 className="text-lg font-medium text-zinc-100">How does it connect to my accounting software?</h3>
                      <p className="mt-2 text-zinc-400 leading-relaxed">Duely connects seamlessly with QuickBooks and Xero, pulling in outstanding invoices automatically.</p>
                    </div>
                  </FadeIn>
                  <FadeIn key={4} delay={4 * 0.05}>
                    <div>
                      <h3 className="text-lg font-medium text-zinc-100">Can I edit the emails before they go out?</h3>
                      <p className="mt-2 text-zinc-400 leading-relaxed">Absolutely. You can choose the tone, generate a draft, and edit it to fit your brand before it's sent.</p>
                    </div>
                  </FadeIn>
              </div>
            </div>
